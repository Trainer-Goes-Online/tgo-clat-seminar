...
const TICKER = [
  ...
  "5th July, Constitution Club of India, New Delhi",
          ...
          <div className="hero-layout">
            ...
            <div className="hmeta">
              <div className="hcard reveal reveal-d1">
                ...
                <span className="hcard-v">5th July, Sunday</span>
              </div>
        ...
        <div className="inner">
          ...
          <div className="imagine reveal">
            <div className="snapshot">
              ...
              <div className="snap-foot"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2.6l8 3v5.4c0 4.4-3 7.6-8 8.8-5-1.2-8-4.4-8-8.8V5.6z"/><path d="M9 12l2 2 4-4.2"/></svg>We built CLAT Possible to make this real for students like you. The 5th July seminar is where it begins.</div>
            </div>
          </div>
