    ...
    <div className="page-stage page-light">
      ...
      <div className="wrap">
        ...
        <div className="wa wa--hero wa--critical">
          ...
          <p className="wa-d">Your 1-on-1 scheduling, the private achievers circle invite, and all updates come through here before <span className="wa-date">5th July</span>.</p>
        ...
        <div className="next">
          ...
          <div className="nrow"><span className="nnum">03</span><p><b>Show up ready on 5th July.</b> Bring your real questions. You leave with your personalized roadmap and a clear plan to a top NLU.</p></div>
        </div>
